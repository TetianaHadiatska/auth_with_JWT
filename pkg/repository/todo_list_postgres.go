...
func (r *TodoListPostgres) Create(userId int, list auth.TodoList) (int, error) {
	tx, err := r.db.Begin()
	if err != nil {
		return 0, err
	}
...
func (r *TodoListPostgres) GetAll(userId int) ([]auth.TodoList, error) {
	var lists []auth.TodoList
...
func (r *TodoListPostgres) GetById(userId, listId int) (auth.TodoList, error) {
	var list auth.TodoList
...
func (r *TodoListPostgres) Update(userId, listId int, input auth.UpdateListInput) error {
